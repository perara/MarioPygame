...
class Goombas(Entity):
    def __init__(self, x_pos, y_pos, move_direction):
        ...
        self.image_tick = 0
        self.images = [
            loaders.get_image('images/goombas_0.png').convert_alpha(),
            loaders.get_image('images/goombas_1.png').convert_alpha(),
            loaders.get_image('images/goombas_dead.png').convert_alpha()
        ]
